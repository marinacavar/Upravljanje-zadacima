  ...
  return (
    <div>
      <Disclosure as="nav">
        ...
        <Disclosure.Panel static className={`p-6 w-1/2 h-screen bg-white z-20 fixed top-0 -left-96 lg:left-0 lg:w-60 peer-focus:left-0 peer:transition ease-out delay-150 duration-200 ${isVisible ? 'left-0' : '-left-96'}`}>
...
// export default function Sidebar({ isVisible, toggleSidebar, username }) {
  // const router = useRouter();
          ...
          {/* <div className="flex flex-col justify-start items-center"> */}
            ...
            {/* <div className="my-4 border-b border-grey-100 pb-4"> */}
              ...
              {/* <Link href="/admin/profile"> */}
                {/* <div className="flex mb-2 justify-start items-center gap-4 pl-5 hover:bg-blue-700 p-2 rounded-md group cursor-pointer hover:shadow-lg"> */}
                  {/* <CgProfile className="text-2xl text-blue-700 group-hover:text-white" /> */}
                  {/* <h3 className='text-base text-blue-900 group-hover:text-white font-semibold'>{username}</h3> */}
                {/* </div> */}
              {/* </Link> */}
              {/* <Link href="/admin/users"> */}
                {/* <div className="flex mb-2 justify-start items-center gap-4 pl-5 hover:bg-blue-700 p-2 rounded-md group cursor-pointer hover:shadow-lg"> */}
